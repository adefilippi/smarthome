<template>
  ...
  >
    ...
    <button
        ...
        @click="selectColor"
    ><Icon name="uil:lightbulb-alt" class="text-7xl" /></button>
  </div>
</template>
...
.rcp__palette {
  ...
  -webkit-mask-image: radial-gradient(circle at 50% 50%, transparent 30%);
  mask-image: radial-gradient(circle at 50% 50%, transparent 30%);
